...
class Calendar {  
  ...
  private function _showDay($cellNumber) {
    ...
    if (($this->currentDay != 0) && ($this->currentDay <= $this->daysInMonth)) {
      ...
      require_once 'sites/all/modules/aae_data/database/db_connect.php';
      $db = new DB_CONNECT();
    ...
    if ($countrows == 0) {
      ...
      return '<li id="event" class="' . ($cellNumber%7==1?' start ':($cellNumber%7==0?' end ':' ')) . ($cellContent==null?'mask':'') . '"><a href="?q=Tag/' . $this->currentDate . '">' . $cellContent . ' (' . $countrows . ')</a></li>';
    }
  }
...
//- See more at: http://www.startutorial.com/articles/view/how-to-build-a-web-calendar-in-php#sthash.SvrYHcMc.dpuf